...
@section('content')
  <div class="content">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('examType.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('Exam Type') }}</h4>
                <p class="card-category">{{ __('Exam Type Information') }}</p>
              </div>
              <div class="card-body ">
