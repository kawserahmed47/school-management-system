...
@section('content')
  <div class="content">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('assignSubject.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      <input class="form-control" name="full_mark" id="input-name" type="text" placeholder="{{ __('Full Mark') }}" value="" required="true" aria-required="true"/>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group">
                      <input class="form-control" name="pass_mark" id="input-name" type="text" placeholder="{{ __('Pass Mark') }}" value="" required="true" aria-required="true"/>
                    </div>
                  </div>
                </div>
