                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header card-header-primary">
                            ...
                            <p class="card-category"> All Teacher Registrations</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 text-right">
                                    <a href="{{ route('teacher.create') }}" class="btn btn-sm btn-primary">Add New</a>
                                </div>
                            </div>
                                        ...
                                        @if ($teachers)
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-actions text-right">
                                                    <a rel="tooltip" class="btn btn-success btn-link" href="{{route('teacher.edit', $teacher->id)}}"
